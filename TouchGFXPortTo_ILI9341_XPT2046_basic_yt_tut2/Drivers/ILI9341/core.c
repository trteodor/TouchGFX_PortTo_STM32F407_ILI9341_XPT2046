...
extern void DMA_SPI_TransmitCompleteILI9341();
...
void DMA1_Str4_TransmitComplete_Callback()   //Call from stm32f4xx_it.c					//Basic function - write those for your MCU !!!!@@@@<#<@<#>#$@!s
{
	...
	DMA_SPI_TransmitCompleteILI9341();
}
